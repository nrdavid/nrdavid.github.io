...
description: >
  This guide is meant for new members of the Sun group, or anyone interested in getting started with the Materials Project API.
sitemap: false
...
![Volcano Plot](/assets/img/blog/volcano_plot_src.png){:.lead width="1059" height="686" loading="lazy"}
...
![Volcano Plot](/assets/img/blog/vscode_python_good.png){:.lead width="621" height="285" loading="lazy"}

Getting Python setup in VSCode.
{:.figcaption}
...
with MPRester(api_key="oDFw0ss23ZMo2Grf4xHfUHlaLj5cygzH") as mpr:
